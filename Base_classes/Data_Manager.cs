...
public class Data_Manager
{
    ...
    string previous_identifier = null;
    ...
    /// <summary>
    /// It will work only when minimum one time the data is loaded
    /// <para>It fetches the data again and the load the data of the data with respect to the identifier given last time</para>
    ///</summary>
    public void load_previous_data_again()
    {
        if(previous_identifier!=null)
        {
            read_data();
            load_data(previous_identifier);
        }
    }
